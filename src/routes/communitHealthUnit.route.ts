...
router.get(
  ...
  (req, res, next) =>
    container.communitHealthUnitController.getAllCommunityHealthUnits(
      req,
      res,
      next,
    ),
...
router.get(
  ...
  (req, res, next) =>
    container.communitHealthUnitController.getCommunityHealthUnitById(
      req,
      res,
      next,
    ),
...
router.post(
  ...
  (req, res, next) =>
    container.communitHealthUnitController.createCommunityHealthUnit(
      req,
      res,
      next,
    ),
